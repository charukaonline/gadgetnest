    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="outline"
          size="icon"
          className="rounded-full border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 hover:bg-zinc-100 dark:hover:bg-zinc-900"
        >
      ...
      >
        <DropdownMenuItem
          ...
          className="cursor-pointer hover:bg-zinc-100 dark:hover:bg-zinc-900 focus:bg-zinc-100 dark:focus:bg-zinc-900"
        >
          <Sun className="h-4 w-4 mr-2 text-zinc-600 dark:text-zinc-400" />
          <span>Light</span>
        </DropdownMenuItem>
        <DropdownMenuItem
          ...
          className="cursor-pointer hover:bg-zinc-100 dark:hover:bg-zinc-900 focus:bg-zinc-100 dark:focus:bg-zinc-900"
        >
          <Moon className="h-4 w-4 mr-2 text-zinc-600 dark:text-zinc-400" />
          <span>Dark</span>
        </DropdownMenuItem>
        <DropdownMenuItem
